...
def scope_name():
    """Returns the name of current scope as a string, e.g. deepr/q_func"""
...
def build_act(make_obs_ph, q_func, num_actions, scope="deepr", reuse=None):
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        logprobs = tf.tile([1.], [num_actions]) + unused_actions_neginf_mask  # -inf is the logprob of 0
...
def build_act_with_param_noise(make_obs_ph, q_func, num_actions, scope="deepr", reuse=None, param_noise_filter_func=None):
