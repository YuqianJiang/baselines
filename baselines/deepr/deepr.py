...
from baselines.deepr.utils import ObservationInput

from baselines.common.tf_util import get_session
from baselines.deepr.models import build_q_func
...
def learn(env,
    ...
    **network_kwargs
    ...
    act, train, update_target, debug = deepr.build_train(
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for t in range(total_timesteps+1):
            ...
            if t > 0 and t % eval_freq == 0 and print_freq is not None and t % (print_freq*eval_freq) == 0:
                ...
                logger.record_tabular("mean " + str(print_freq) + " eval reward", mean_eval_reward)
